          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-sm font-medium" style={{ color: 'var(--color-main)' }}>Vegetale</span>
              </div>
            </div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://t.me/puraessenzavegetale" style={{ color: 'var(--color-main)' }} target="_blank" rel="noopener noreferrer">
              ...
              <a href="https://instagram.com/pura_essenza_vegetale" style={{ color: 'var(--color-main)' }} target="_blank" rel="noopener noreferrer">
              ...
              <a href="https://facebook.com/pura.essenza.vegetale" style={{ color: 'var(--color-main)' }} target="_blank" rel="noopener noreferrer">
