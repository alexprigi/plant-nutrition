...
import { getAdminNotificationEmailHTML, getAdminCancellationEmailHTML, getAdminRescheduleEmailHTML, getClientCancellationEmailHTML, getAdminExpiredBankTransferEmailHTML } from '@/lib/email-templates/admin-notification';
...
export default function EmailPreviewClient() {
  const tabs = useMemo(() => [
    ...
    {
      id: 'admin-expired-bank',
      label: 'Admin — Bonifico Scaduto',
      html: withLocalImages(getAdminExpiredBankTransferEmailHTML({
        clientName: 'Alessandro Bianchi',
        clientEmail: 'alessandro.bianchi@example.com',
        clientPhone: '+39 333 123 4567',
        serviceName: 'Visita Singola',
        date: '2026-06-12',
        time: '15:30',
        isTest: true,
      })),
