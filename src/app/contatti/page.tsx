    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 relative overflow-hidden" style={{ background: 'var(--bg-section-light)' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              ...
              <div className="space-y-6">
                ...
                <Card className="p-6" style={{ background: 'var(--bg-section-warm)', minHeight: '96px' }}>
                  <div className="flex items-center space-x-4 h-full">
                    ...
                    <div>
                      <h3 className="font-semibold mb-1" style={{ color: 'var(--brand-title)' }}>Bonifico Bancario</h3>
                      <p style={{ color: 'var(--text-darker)' }}>
                        Beneficiario: <strong>Arianna Ciervo</strong><br />
                        IBAN: <span style={{ fontFamily: 'monospace' }}>DE14 1001 1001 2175 0735 33</span>
                      </p>
                    </div>
                  </div>
                </Card>
          ...
          {/* Social — centrati sotto le due colonne */}
          <div className="text-center mt-12">
            ...
            <div className="flex justify-center space-x-4">
              ...
              <a
                href="https://t.me/vivaplantnuition"
